...
public class CurrencyPane extends BorderPane implements Callable<Node> {
    ...
    private Pane genInfoPane() {
        ...
        if (this.currency != null) {
            ...
            if (this.currency.isWatch() == true) {
                watchString.setText(String.format("(Watch @%.4f)", this.currency.
                        getWatchRate()));
            }
        }
